...
- [x] 完成 `07-22-session-active-role-cache`，包含基线、session field、mutation path 同步和 fail-closed 回归。
- [x] 更新 backend/frontend spec，特别是 route organization、authorization boundary、dynamic navigation 和 oRPC SSR boundary。
- [x] 从 `TODO.md` 删除已完成事项或改为剩余 follow-up，并保留链接到归档任务。
